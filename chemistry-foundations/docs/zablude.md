...
| 79 | „Brz ANN je dobar retrieval sistem.“ | ANN može tiho propustiti relevantne kandidate. Latency bez recall-a nije validacija. | Meri candidate recall prema exhaustive exact oracle-u iste reprezentacije i metrike, nad istim korpusom i hard filterima, ukupno i po slice-ovima. |
