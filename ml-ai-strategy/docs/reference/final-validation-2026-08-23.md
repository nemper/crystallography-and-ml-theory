...
- U Git tree-u nije bilo dostavljenih fakultetskih/CSD raw fajlova; jedini kontrolisani primer bio je sintetički CC0 `docs/assets/open/tutorial-minimal.cif`.
...
| Sloj | Obuhvat |
|---|---|
| glavni hemijski kurs | svih 38 tadašnjih Markdown modula; detaljan raniji audit je u `docs/referenca/validacioni-audit-2026-08-23.md` |
...
| CIF izgled | pun sintetički data block, tag/value, loop, ćelija, simetrija, atom sites, `?`, `.`, s.u. i text field | `docs/podaci/12a-anatomija-cif.md` i `tutorial-minimal.cif` |
