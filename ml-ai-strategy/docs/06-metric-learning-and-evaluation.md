...
Dataset i pair builder najpre prolaze [cross-format i lifecycle eligibility ugovor](09-cross-format-eligibility.md): svi source pogledi istog entry-ja grupišu se pre split-a, representation availability ulazi u denominator/slice metrike, a state transition invalidira pogođene labele, embedding-e, indekse i model lineage.
